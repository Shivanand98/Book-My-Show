...
public class MovieServiceImpl implements MovieService {
    ...
    @Override
    public MovieResponseDto addMovie(MovieEntryDto movieEntryDto) throws Exception {
        ...
        if(movieRepository.existsByName(movieEntryDto.getName()) != null ){
            
           throw new Exception("movie already present");
        }
